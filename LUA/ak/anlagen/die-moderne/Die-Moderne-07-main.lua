...
k2_r1_fg = AkRichtung:neu("R1 FG", -1, {
    AkAmpel:neu(101, AkAmpelModell.JS2_2er_nur_FG):fuegeAchsenImmoHinzu("#5816_Warnblink Fu�g�nger rechts", "Blinklicht", 0, nil, nil, nil, 50),
    AkAmpel:neu(102, AkAmpelModell.JS2_2er_nur_FG):fuegeAchsenImmoHinzu("#5815_Warnblink Fu�g�nger links", "Blinklicht", 0, nil, nil, nil, 50)
})
