...
do
    ...
    do
        ...
        c1Switching1:addCarLights(K1, K10, K11)
        c1Switching1:addTramLights(S1, S2)
        c1Switching1:addPedestrianLights(F1, F2, F5, F6)
    end

    do
        local c1Switching1a = c1:newSequence("S1a")
        c1Switching1a:addCarLights(K1, K9, K10, K11)
        c1Switching1a:addTramLights(S2)
        c1Switching1a:addPedestrianLights(F5, F6)
    end
    ...
    do
        ...
        c1Switching2:addCarLights(K2, K3, K5)
        c1Switching2:addTramLights(S4, S3)
    end

    do
        --- Kreuzung 1: Schaltung 3
        local c1Switching3 = c1:newSequence("S3")
        c1Switching3:addCarLights(K4, K6, K7, K8, K9)
    end

    do
        local c1Switching3a = c1:newSequence("S3a")
        c1Switching3a:addCarLights(K4, K12, K13, K14)
        c1Switching3a:addPedestrianLights(F3, F4, F7, F8)
    end

    do
        --- Kreuzung 1: Schaltung 4
        local c1Switching4 = c1:newSequence("S4")
        c1Switching4:addCarLights(K9, K10, K11)
        c1Switching4:addTramLights(S2, S4)
    end

    do
        local c1Switching4a = c1:newSequence("S4a")
        c1Switching4a:addCarLights(K9, K10, K11)
        c1Switching4a:addTramLights(S3, S4)
    end
...
do
    ...
    c2Switching1:addPedestrianLights(F3, F4, F5, F6)

    --- Kreuzung 2: Schaltung 1a
    local c2Switching1a = c2:newSequence("S1a")
    c2Switching1a:addCarLights(K2, K3)
    c2Switching1a:addPedestrianLights(F1, F2, F3, F4)

    --- Kreuzung 2: Schaltung 1b
    local c2Switching1b = c2:newSequence("S1b")
    c2Switching1b:addCarLights(K1)
    c2Switching1b:addTramLights(S2)
    c2Switching1b:addPedestrianLights(F1, F2, F3, F4)

    --- Kreuzung 2: Schaltung 2
    local c2Switching2 = c2:newSequence("S2")
    c2Switching2:addCarLights(K4, K5, K6)
    c2Switching2:addTramLights(S1, S2)
    c2Switching2:addPedestrianLights(F7, F8, F3, F4)

    --- Kreuzung 2: Schaltung 2a
    local c2Switching2a = c2:newSequence("S2a")
    c2Switching2a:addCarLights(K4, K5, K6, K7, K8)
    c2Switching2a:addPedestrianLights(F7, F8, F9, F10)

    --- Kreuzung 2: Schaltung 3
    local c2Switching3 = c2:newSequence("S3")
    c2Switching3:addCarLights(K9, K10)
    c2Switching3:addTramLights(S1, S2) -- strab
    c2Switching3:addPedestrianLights(F1, F2)

    --- Kreuzung 2: Schaltung 3a
    local c2Switching3a = c2:newSequence("S3a")
    c2Switching3a:addCarLights(K7, K8, K9, K10)
...
sHauptbahnhof:addDisplay("#207_Tram Schild Gelb DL1", RSDM.Tram_Schild_DL1, 1) -- Display für Steig 1
...
sHauptbahnhof:addDisplay("#288_BusHS Tram Info_6_RG3", RSDM.BusHS_Tram_Info_6_RG3, 2) -- Display für Steig 2
sHauptbahnhof:addDisplay("#289_BusHS Tram dfi_6_RG3", RSDM.BusHS_Tram_dfi_6_RG3, 2) -- Display für Steig 2
sHauptbahnhof:addDisplay("#155_Tram Schild Gelb DL1", RSDM.Tram_Schild_DL1, 2) -- Display für Steig 2
...
-- sMainStation:addDisplay("#273_BusHSdfi_RG3", RSDM.BusHSdfi_RG3, 1)
sFeuerwehrGasse:setPlatform(l10MesseDresden, 2)
sFeuerwehrGasse:addDisplay("#273_BusHSdfi_RG3", RSDM.BusHSdfi_RG3, 2)
sFeuerwehrGasse:addDisplay("#275_BusHSInfo_RG3", RSDM.BusHSInfo_RG3, 2)

sAmAltenMarkt = RoadStation:new("Am alten Markt", -1)
sAmAltenMarkt:setPlatform(l04RadebeulWest, 1)
sAmAltenMarkt:addDisplay("#290_BusHS Tram Info_6_RG3", RSDM.BusHS_Tram_Info_6_RG3, 1) -- Display für Steig 1
sAmAltenMarkt:addDisplay("#291_BusHS Tram dfi_6_RG3", RSDM.BusHS_Tram_dfi_6_RG3, 1) -- Display für Steig 1
sAmAltenMarkt:setPlatform(l04Striesen, 2)
sAmAltenMarkt:addDisplay("#292_BusHS Tram Info_6_RG3", RSDM.BusHS_Tram_Info_6_RG3, 2) -- Display für Steig 2
sAmAltenMarkt:addDisplay("#293_BusHS Tram dfi_6_RG3", RSDM.BusHS_Tram_dfi_6_RG3, 2) -- Display für Steig 2

-- Haltestelle Messe Dresden
sMesseDresden = RoadStation:new("Messe Dresden", -1)
