...
run(); B_BL1_1_WST(trainName1); run()
...
run(); V_BL1_1_GBG_GL_2_WST(trainName1); run()
...
run(); B_BL1_1_WST(trainName2); run()
...
run(); V_BL1_1_GBG_GL_3_WST(trainName2); run()
assert(block1Gl1.trainName == nil)
assert(gruenbergGleis2.trainName == trainName1)
assert(gruenbergGleis3.trainName == trainName2)
assert(gruenbergGleis4.trainName == nil)
...
run(); B_GBG_GL_2_WST(trainName1); run()
assert(block1Gl1.trainName == nil)
assert(gruenbergGleis2.trainName == trainName1)
assert(gruenbergGleis3.trainName == trainName2)
assert(gruenbergGleis4.trainName == nil)
...
run(); B_GBG_GL_3_WST(trainName2); run()
assert(block1Gl1.trainName == nil)
assert(gruenbergGleis2.trainName == trainName1)
assert(gruenbergGleis3.trainName == trainName2)
assert(gruenbergGleis4.trainName == nil)
...
run(); V_GBG_GL_X_WST(trainName1); run()
assert(block1Gl1.trainName == nil)
...
run(); B_BL2_1_WST(trainName1); run()
assert(block1Gl1.trainName == nil)
assert(gruenbergGleis2.trainName == nil)
assert(gruenbergGleis3.trainName == trainName2)
assert(gruenbergGleis4.trainName == nil)
...
run(); V_GBG_GL_X_WST(trainName2); run()
assert(block1Gl1.trainName == nil)
assert(gruenbergGleis2.trainName == nil)
assert(gruenbergGleis3.trainName == nil)
assert(gruenbergGleis4.trainName == nil)
